...
"""autogenerated by genpy from my_pkg/reach_positionActionFeedback.msg. Do not edit."""
import sys
...
class reach_positionActionFeedback(genpy.Message):
  _md5sum = "11a8430139263fa1f233bb7fbc11af19"
  _type = "my_pkg/reach_positionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_pkg/reach_positionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(reach_positionActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = my_pkg.msg.reach_positionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = my_pkg.msg.reach_positionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.feedback.distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.distance,) = _get_struct_i().unpack(str[start:end])
      return self
