...
"""autogenerated by genpy from my_pkg/reach_positionActionResult.msg. Do not edit."""
import sys
...
class reach_positionActionResult(genpy.Message):
  _md5sum = "15cdb5417856fa252e79c6e087060ea2"
  _type = "my_pkg/reach_positionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_pkg/reach_positionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(reach_positionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = my_pkg.msg.reach_positionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = my_pkg.msg.reach_positionResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.result.time))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.time,) = _get_struct_i().unpack(str[start:end])
      return self
